...
<div class="contact-layout">
  ...
  <div class="contact-left">
    ...
    <p>Whether you have questions about courses, need help with your account, or want to discuss a Teams plan — our team
  ...
  <div class="contact-right">
    ...
    <?php if ($success): ?>
      <div
        style="background:rgba(34, 197, 94, 0.1); color:var(--sage); padding:1rem; border-radius:6px; margin-bottom:1.5rem; border:1px solid rgba(34, 197, 94, 0.2);">
        <?php echo $success; ?>
      </div>
    <?php endif; ?>
